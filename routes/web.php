...
Route::get('admin/signout', [AdminController::class, 'signout'])->name('signout.admin');
...
Route::get('/shop/search', [UserController::class, 'searchProduct'])->name('searchProduct');
Route::get('/detail/{ProductId}', [UserController::class, 'detail'])->name('detail');
Route::get('/showcart', [UserController::class, 'showcart'])->name('showcart');
Route::get('/delete_cart/{OrderId}', [UserController::class, 'delete_cart'])->name('delete_cart');
Route::get('/contact', [UserController::class, 'contact'])->name('contact');

// route::get('/add_cart/{ProductId}',[UserController::class, 'add_cart'])->name('add_cart');
route::post('/add_cart/{ProductId}',[UserController::class, 'add_cart'])->name('add_cart');
