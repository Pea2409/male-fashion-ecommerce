          ...
          <div class="col-lg-8">
            <div class="instagram__pic">
              <div
                ...
                data-setbg="user/img/instagram/instagram-1.jpg"
              ></div>
              <div
                class="instagram__pic__item set-bg"
                data-setbg="user/img/instagram/instagram-2.jpg"
              ></div>
              <div
                class="instagram__pic__item set-bg"
                data-setbg="user/img/instagram/instagram-3.jpg"
              ></div>
              <div
                class="instagram__pic__item set-bg"
                data-setbg="user/img/instagram/instagram-4.jpg"
              ></div>
              <div
                class="instagram__pic__item set-bg"
                data-setbg="user/img/instagram/instagram-5.jpg"
              ></div>
              <div
                class="instagram__pic__item set-bg"
                data-setbg="user/img/instagram/instagram-6.jpg"
              ></div>
            </div>
          </div>
          <div class="col-lg-4">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="blog__item">
              <div
                ...
                data-setbg="user/img/blog/blog-1.jpg"
              ></div>
              <div class="blog__item__text">
                <span
                  ><img src="user/img/icon/calendar.png" alt="" /> 16 February
                  2020</span
                >
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="blog__item">
              <div
                class="blog__item__pic set-bg"
                data-setbg="user/img/blog/blog-2.jpg"
              ></div>
              <div class="blog__item__text">
                <span
                  ><img src="user/img/icon/calendar.png" alt="" /> 21 February
                  2020</span
                >
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="blog__item">
              <div
                class="blog__item__pic set-bg"
                data-setbg="user/img/blog/blog-3.jpg"
              ></div>
              <div class="blog__item__text">
                <span
                  ><img src="user/img/icon/calendar.png" alt="" /> 28 February
                  2020</span
                >
